    ...
    <div class="table-wrapper has-mobile-cards">
      <table tabindex="0" class="table is-hoverable">
        <thead>
          <tr>
            <th class="">
              <div class="th-wrap">Owner</div>
            </th>
            <th class="">
              <div class="th-wrap is-centered">Hashtags</div>
            </th>
            <th class="">
              <div class="th-wrap is-centered">Tag count</div>
            </th>
            <th class="">
              <div class="th-wrap is-centered">Revenue</div>
            </th>
            <!---->
          </tr>
          <!---->
        ...
        <tbody>
          <tr draggable="false" class="">
            ...
            <td data-label="Owner" class="">
              <span
                ><span
                  data-label="0x477cec669b2b22e79fad05d1c034fc9d897ad4ef"
