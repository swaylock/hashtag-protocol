    ...
    <div class="container">
      ...
      <div class="tile is-ancestor">
        <div class="tile is-horizontal">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <eth-account :value="foundPublisher.address"></eth-account>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a v-bind:href="foundPublisher.website"
                            >{{ foundPublisher.website }} <b-icon icon="open-in-new" size="is-small"> </b-icon
                          ></a>
                        </td>
                      </tr>
                    </tbody>
          ...
          <div class="tile is-parent is-6 is-12-mobile">
            <div class="tile is-child box">
              <h2 class="title is-4">Market summary for {{ foundPublisher.name }}</h2>
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <eth-amount :value="publisherByAcc.tagFees"></eth-amount>
                        </td>
                      </tr>
                      <tr>
      ...
      <div class="columns is-tablet is-centered">
        <div class="column is-12">
          <article class="is-white box">
            <h2 class="title is-4 is-spaced">Recent activity on {{ foundPublisher.name }}</h2>
                  ...
                  <div class="table-wrapper has-mobile-cards">
                    <table class="table">
                      ...
                      <tbody v-if="hashtagsByPublisher">
                        <tr v-for="hashtag in hashtagsByPublisher" v-bind:key="hashtag.id">
                          <!---->
                          <!---->
                          ...
                          <td data-label="Creator" class="">
                            <eth-account :value="hashtag.creator" route="owner-address"></eth-account>
                          </td>
                  ...
                  <div class="table-wrapper has-mobile-cards">
                    <table class="table">
                      ...
                      <tbody v-if="tagsByPublisher">
                        <tr v-for="tag in tagsByPublisher" v-bind:key="tag.id">
    ...
    foundPublisher() {
      if (this.publisherDirectory) {
        const filteredResults = this.publisherDirectory.filter(
          (publisher) =>
            ethers.utils.getAddress(publisher.address) === ethers.utils.getAddress(this.$route.params.address),
        );
