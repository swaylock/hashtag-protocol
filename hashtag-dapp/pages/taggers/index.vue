      ...
      <div class="columns is-tablet is-centered">
        <div class="column is-12">
          <article class="is-white box">
              ...
              <div class="table-wrapper has-mobile-cards">
                <table tabindex="0" class="table is-hoverable">
                  ...
                  <tbody v-if="pagedTaggers">
                    <tr draggable="false" class="" v-for="tagger in pagedTaggers" v-bind:key="tagger.id">
                      <!---->
                      <!---->
                      <td data-label="Tagger" class="">
                        <eth-account :value="tagger.id" route="tagger-address"></eth-account>
                      </td>
            ...
            <Pagination :entity-count="taggersCount" :page-size="pageSize" @tabSelected="tabSelected" />
          </article>
        </div>
      </div>
    </div>
