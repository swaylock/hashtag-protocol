      ...
      <div class="columns is-tablet is-centered">
        <div class="column is-12">
          <article class="is-white box">
              ...
              <div class="table-wrapper has-mobile-cards">
                <table tabindex="0" class="table is-hoverable">
                  ...
                  <tbody v-if="pagedHashtags">
                    <tr draggable="false" class="" v-for="hashtag in pagedHashtags" v-bind:key="hashtag.id">
                      <!---->
                      <!---->
            ...
            <Pagination :entity-count="hashtagCount" :page-size="pageSize" @tabSelected="tabSelected" />
          </article>
        </div>
      </div>
    </div>
