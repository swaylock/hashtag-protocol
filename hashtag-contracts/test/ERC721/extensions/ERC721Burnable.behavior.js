...
function shouldBehaveLikeERC721Burnable (errorPrefix, admin, publisher, operator, approved, anotherApproved, other, newOwner, creator) {
  ...
  context('like a burnable ERC721', function () {
    ...
    describe('burn', function () {
      ...
      describe('when the given token ID was not tracked by this contract', function () {
        it('reverts', async function () {
          await expectRevert(
            this.token.burn(unknownTokenId, { from: admin }), 'ERC721: operator query for nonexistent token',
          );
        });
      });
      ...
      describe('when attempted by non-administrator', function () {
        it('reverts', async function () {
          ...
          await expectRevert(
            this.token.burn(firstTokenId, { from: newOwner }), 'Caller must have administrator access',
          );
        });
      });
    });
