...
contract("ERC721", function (accounts) {
  ...
  describe("metadata", function () {
    ...
    it("has a symbol", async function () {
      expect(await this.token.symbol()).to.be.equal("HASHTAG");
    });
    ...
    describe("ownerOf", function () {
      context("when the given token ID was tracked by this token", function () {
        it("returns address zero when token is owned by platform", async function () {
          ...
          expect(
            (await this.token.tokenIdToHashtag(firstTokenId)).creator
          ).to.be.equal(creator);
        });
    ...
    describe("transfers", function () {
      ...
      const shouldTransferTokensByUsers = function (transferFunction) {
        ...
        context("when sent to the owner", function () {
          beforeEach(async function () {
            await transferFunction.call(this, owner, other, tokenId, {
              from: owner,
            });
